      ...
      <div className="isolate relative bg-gray-900 px-6 py-24 lg:px-8 rounded-2xl">
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-2 text-md/8 text-gray-400">
            Napravite nalog i zakažite termin. Moći ćete da ostavite vaše utiske
            i preporuke.
          </p>
        </div>
        <form
        ...
        >
          ...
          <div className="mt-10">
            <button
              type="submit"
              className="cursor-pointer block w-full rounded-md bg-(--secondary-color) px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-xs hover:bg-(--secondary-color)/80 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-(--secondary-color)"
            >
              {"Registruj se"}
            </button>
          </div>
